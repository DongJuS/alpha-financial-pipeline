...
class OrchestratorAgent:
    def __init__(
        ...
        if independent_portfolio and strategies:
            for s in strategies:
                self._get_portfolio_for_strategy(s)
