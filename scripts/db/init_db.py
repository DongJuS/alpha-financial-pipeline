...
CREATE_TABLES: list[str] = [
    ...
    CREATE INDEX IF NOT EXISTS idx_rl_training_jobs_instrument
        ON rl_training_jobs(instrument_id);
    CREATE INDEX IF NOT EXISTS idx_rl_training_jobs_status
        ON rl_training_jobs(status);
    """,
    ...
    CREATE INDEX IF NOT EXISTS idx_rl_experiments_instrument
        ON rl_experiments(instrument_id);
    CREATE INDEX IF NOT EXISTS idx_rl_experiments_job
        ON rl_experiments(job_id);
    """,
